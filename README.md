...
- Gemini is used for structured JD parsing when `GEMINI_API_KEY` is present.
- OpenRouter uses `nvidia/nemotron-3-super-120b-a12b:free` by default for one shortlist-review agent call per uncached run.
